...
/*   Updated: 2022/03/21 14:41:29 by yhwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_pvt(t_stack *a, int len, char stack_flag, t_data_struct *data_struct)
{
	int	*arr;
	int	std_pvt;
...
static void	divide_a(t_stack **a, t_stack **b, int len, t_data_struct *data_struct)
{
	while (len > 0)
	{
